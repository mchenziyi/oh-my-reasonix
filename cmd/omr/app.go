...
func usage() {
	fmt.Printf("%s init|upgrade|uninstall|doctor|config|profile|session|benchmark|comment-check|evolve|memory(get|pin|unpin|freeze|unfreeze|archive|episodic|usage|outcome)|version\n", os.Args[0])
